...
The data is taken from Encode Experiment [ENCSR817LUF](https://www.encodeproject.org/experiments/ENCSR817LUF/) (chIP-Seq). The accession ID of the raw sequence read data is [ENCFF397NRK](https://www.encodeproject.org/files/ENCFF397NRK/). Genomic data comes in many file formats. These specific raw sequence reads is a compressed FASTQ file.
...
<a href="https://mybinder.org/v2/gh/sn2023imperial/genomicsmarkdown/main?labpath=notebook_tutorials%2FTutorial_1_bigWigs.ipynb" target="_blank">Tutorial 1: Dealing with bigWigs</a>
